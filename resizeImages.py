...
for path, subdirnames, filenames in os.walk("C:/Users/Dinesh/PycharmProjects/FaceRecognition-master/trainingImages"):
    ...
    for filename in filenames:
      ...
      new_path="C:/Users/Dinesh/PycharmProjects/FaceRecognition-master/resizedTrainingImages"+"/"+str(id)
